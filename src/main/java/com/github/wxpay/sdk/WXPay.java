...
public class WXPay {
    ...
    public WXPay(final WXPayConfig config, final String notifyUrl, final boolean autoReport, final boolean useSandbox) throws Exception {
        ...
        this.wxMisc = new WXMisc(config, this);
    }
    public Map<String, String> setJsApiPath(String sub_mch_id, String jsapi_path) throws Exception {
        return wxMisc.setJsApiPath(sub_mch_id, jsapi_path);
    }
    public Map<String, String> regMicro(Map<String, String> reqData) throws Exception {
        return wxMisc.regMicro(reqData);
    }
    public Map<String, String> changeMicroContactInfo(Map<String, String> reqData) throws Exception {
        return wxMisc.changeMicroContactInfo(reqData);
    }
    public Map<String, String> changeMicroBankCard(Map<String, String> reqData) throws Exception {
        return wxMisc.changeMicroBankCard(reqData);
    }
    public Map<String, String> queryMicroByApplyId(String applyment_id) throws Exception {
        return wxMisc.queryMicroByApplyId(applyment_id);
    }
    public Map<String, String> queryMicroByBusiCode(String business_code) throws Exception {
        return wxMisc.queryMicroByBusiCode(business_code);
    }
    public Map<String, String> getCert() throws Exception {
        Map<String, String> resData = wxMisc.getCert();

        return resData;
    }
    public Map<String, String> upload(File file) throws Exception {
        String respXml = wxMisc.upload(file);
        // return data with md5 sign, so skip check sign
    ...
    public String signData(Map<String, String> reqData) throws Exception {
        return WXPayUtil.generateSignature(reqData, config.getKey(), this.signType);
    }
    /**
    ...
    public boolean isPayResultNotifySignatureValid(Map<String, String> reqData) throws Exception {
        ...
        return WXPayUtil.isSignatureValid(reqData, this.config.getKey(), SignType.HMACSHA256);
    }
    ...
    public String requestWithoutCert(String urlSuffix, Map<String, String> reqData) throws Exception {
        return this.requestWithoutCert(urlSuffix, reqData, this.config.getHttpConnectTimeoutMs(), this.config.getHttpReadTimeoutMs());
    }
    ...
    public String requestWithCert(String urlSuffix, Map<String, String> reqData) throws Exception {
        return this.requestWithCert(urlSuffix, reqData, this.config.getHttpConnectTimeoutMs(), this.config.getHttpReadTimeoutMs());
    }
    /**
    ...
    public Map<String, String> downloadBill(Map<String, String> reqData, int connectTimeoutMs, int readTimeoutMs) throws Exception {
        ...
        if (respStr.indexOf("<") == 0) {
            ...
            ret.put("result_code", WXPayConstants.SUCCESS);
